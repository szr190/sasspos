(function($){
	    ...
	    $(function(){
	        ...
	        api.button({
	            ...
	            callback: function() {
	                ...
	                //    Public.tips({type:2,content:"请选择一个SKU！"});
	                //    return false;
	                //}
                    //获取所有选中行
    ...
    $(function(){
        ...
        //使用列设置数据的方式初始化jqGrid
        function getUrl() {
            if(window.api.data.dataUrl.indexOf('opGetSkuForAdjust')) {
                return window.api.data.dataUrl.replace(/opGetSkuForAdjust/ig,'opGetStoreSkuBySearch');
            }else{
                return window.api.data.dataUrl
            }
        }
        Public.jqGrid("#grid",{
            url: getUrl(),//获取数据的url
            ...
            colModel:[
                ...
                {name: 'itemName', label:'商品名称', index: 'itemName', align: 'center',width: 150, title: false},
                {name: 'specMemo', label:'规格', index: 'itemCode', align: 'center', width: 100, title: false},
                ...
                {name: 'icatName', label:'类别', index: 'icatName', width: 100, align: 'center', fixed:true, title: false},
                {name: 'stockUnit', hidden: true},
