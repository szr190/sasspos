(function($){
    ...
    $(function(){
        ...
        Public.jqGrid("#grid",{
            ...
            operateCol:false,
            colModel:[
                {name: 'brandCode', label:'品牌编码', index: 'brandCode', align: 'center',width: 100, title: false},
                {name: 'brandName', label:'品牌名称', index: 'brandName', align: 'center',width: 100, title: false},
                {name: 'parentCode', label:'上级品牌编码', index: 'parentCode', align: 'center', width: 100, title: false},
                  {name: 'parentName', label:'上级品牌名称', index: 'parentName', width: 100, align: 'center', fixed:true, title: false}
            ],
            autowidth:true,
            autoHeight:true,
